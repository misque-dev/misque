...
isAtKaaba({ latitude: 21.4230, longitude: 39.8270 }, 1);   // true
```
...
const compass2 = createQiblaCompass({ latitude: 40.7128, longitude: -74.0060 });
...
compass.updateCoordinates({ latitude: 40.7200, longitude: -74.0100 });
```
